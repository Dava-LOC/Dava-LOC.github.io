jQuery(document).ready(function($) {
	...
	$( document ).on( 'click', '#eckb-kb-create-demo-data', function( e ) {
		...
		let parent_container = $( this ).closest( '.eckb-kb-no-content' ),
			confirmation_box = parent_container.find( '#epkb-admin__generic-confirmation-box' );
		...
		$.ajax( {
			...
			if ( typeof response.message !== 'undefined' ) {
				confirmation_box.addClass( 'epkb-admin__generic-confirmation-box--active' ).find( '.epkb-admin__generic-confirmation-box__body' ).html( response.message );
			}

		} ).fail( function( response, textStatus, error ) {
			confirmation_box.addClass( 'epkb-admin__generic-confirmation-box--active' ).find( '.epkb-admin__generic-confirmation-box__body' ).html( error );
	...
	$( document ).on( 'click', '.eckb-kb-no-content .epkb-admin__generic-confirmation-box__accept-btn', function() {
		location.reload();
	} );
});
